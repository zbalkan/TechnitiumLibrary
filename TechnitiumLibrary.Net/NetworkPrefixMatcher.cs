...
namespace TechnitiumLibrary.Net
{
    ...
    /// Suited to any per-request allow, deny, or bypass list that is rebuilt rarely and read
    /// often. Lookups (<see cref="IsMatch"/>) are allocation-free; building a matcher (<see
    /// cref="Create"/>) is not.
    /// </summary>
    /// <remarks>
